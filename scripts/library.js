let selections = [
    ...
    },
    {
        ...
        description: '208 000 аудиокниг',
        books: [
            {
                cover: '../assets/images/audio-cover.jpg',
                rating: 4,
                title: 'Илон Маск. Уолтер Айзексон. Саммари',
    ...
    {
        title: 'Авторы',
        description: '128 470 авторов',
        books: [
            {
                cover: '../assets/images/author-cover.jpg',
                rating: 0,
                title: 'Стивен Кинг',
                author: '17 книг',
                to: '../pages/book.html'
